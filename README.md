...
This is the welcome flow plus four real pages, not the whole app.
...
**Not built:**
- The other five pages — Goals, Campus Map, Opportunities, Chat, Friends — are listed on the board page as static description cards tagged "Soon," not real pages. Chat and Friends in particular are a poor fit for this architecture (no backend means no real multi-user data) and may stay stubs.
